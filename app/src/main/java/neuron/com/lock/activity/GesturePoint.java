...
public class GesturePoint {
	...
	public void setPointState(int state) {
		...
		case Constants.POINT_STATE_NORMAL:
			this.image.setBackgroundResource(R.mipmap.login_gesture_default);
			break;
		case Constants.POINT_STATE_SELECTED:
			this.image.setBackgroundResource(R.mipmap.login_gesture_correct);
			break;
		case Constants.POINT_STATE_WRONG:
			this.image.setBackgroundResource(R.mipmap.login_gesture_false);
			break;
		default:
			break;
		}
