...
public class VerifyCodeInput {
    ...
    public static AlertDialog VerifyCodeInputDialog(final Context context, final VerifyCodeInputListener l, final String cameraNo) {
        ...
        builder.setNegativeButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SharedPreferencesManager.getInstance(context).save(cameraNo, verifyCode);
